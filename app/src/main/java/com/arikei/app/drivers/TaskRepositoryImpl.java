...
public class TaskRepositoryImpl implements TaskRepositoryIF {
  ...
  public List<Task> fetchList(String boardId) {
    return List.of(new Task("1", "1-1", "タスク名称未着手1", "タスク説明", LocalDateTime.now(), 1),
        ...
        new Task("1", "1-1", "タスク名称未着手7", "タスク説明7", LocalDateTime.now(), 7),
        new Task("1", "1-1", "タスク名称未着手3", "タスク説明3", LocalDateTime.now(), 3),
        new Task("1", "1-1", "タスク名称未着手4", "タスク説明4", LocalDateTime.now(), 4),
        new Task("1", "1-1", "タスク名称未着手5", "タスク説明5", LocalDateTime.now(), 5),
        new Task("1", "1-1", "タスク名称未着手8", "タスク説明8", LocalDateTime.now(), 8),
        new Task("1", "1-1", "タスク名称未着手6", "タスク説明6", LocalDateTime.now(), 6),
